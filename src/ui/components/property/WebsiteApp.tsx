    ...
    <div style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 500, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 8 }}>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 6px 24px rgba(37,211,102,0.4), 0 2px 8px rgba(0,0,0,0.12)',
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <svg width="26" height="26" viewBox="0 0 24 24" fill="#fff" style={{ position: 'relative', zIndex: 1, flexShrink: 0 }}>
        ...
        <div className="reveal-child" style={{ opacity: 0, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.background = '#1DB954'; e.currentTarget.style.transform = 'scale(1.03)'; }}
